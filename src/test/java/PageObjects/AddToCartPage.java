...
public class AddToCartPage {
    ...
    public static void addToCart() {
        ...
        System.out.println("Scrolled to bottom to find next page");
        ...
        System.out.println("waited for element to locate");

        WebElement laptop_ele = driver.findElement(laptop);
        SeleniumMethods.scrollToElement(laptop_ele, driver);
        System.out.println("Scrolled to desired product element");

        SeleniumMethods.setImplicitlyWait(driver, 5);
        laptop_ele.click();
        System.out.println("clicked on desired product element");
